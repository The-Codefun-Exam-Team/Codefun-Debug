      ...
      >
          ...
          {({ checked }) => (
            <div
              className={clsx(
                ...
                checked
                  ? "border-blue-400 dark:border-sky-300"
                  : "border-transparent hover:border-blue-200 hover:dark:border-sky-200",
              )}
            >
              <MoonIcon className="h-6 w-6 stroke-blue-500 dark:stroke-sky-300" aria-label="Dark" />
            </div>
          )}
        </RadioGroup.Option>
        <RadioGroup.Option value={null} title="Default">
          {({ checked }) => (
            ...
            >
              <ComputerIcon
                className="h-6 w-6 stroke-blue-500 dark:stroke-sky-300"
                aria-label="System"
              />
            </div>
          )}
        ...
        <RadioGroup.Option value="light" title="Light">
          {({ checked }) => (
            ...
            >
              <SunIcon className="h-6 w-6 stroke-blue-500 dark:stroke-sky-300" aria-label="Light" />
            </div>
          )}
        </RadioGroup.Option>
      </RadioGroup>
...
export const UserInfo = () => {
  ...
  const menuItemsClassName =
    "w-full rounded-none text-left transition-colors duration-200 hover:text-blue-500 dark:hover:text-sky-300";
  return (
    <>
        ...
        <Menu as="div" className="relative">
          <Menu.Button
            className={clsx(
              ...
              "outline-none focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-sky-300",
