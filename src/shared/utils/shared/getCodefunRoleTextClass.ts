 ...
 * @returns
 */
export const getCodefunRoleTextClass = (role: CodefunRoles | null | undefined) => {
  if (!role) {
  ...
  return clsx("font-bold", {
    ...
    "text-user-beginner-light dark:text-user-beginner-dark": role === "beginner",
    ...
    "text-user-problemsetter dark:text-user-problemsetter": role === "problemsetter",
    "text-user-admin-light dark:text-user-admin-dark": role === "admin",
    "text-user-grandmaster-light dark:text-user-grandmaster-dark": role === "grandmaster",
  });
};
